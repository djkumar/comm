      ...
      <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content">
          ...
          <div class="tab-pane" id="winter_collection">
            <div class="row">
              ...
              <div class="col-sm-4">
                <img src="<?php echo e(asset('resources/assets/images/add-sample/winter.jpg')); ?>" class="img-responsive" alt="">
              </div>
            </div>
          </div>
        <div class="tab-pane" id="summer_collection">
          <div class="row">
            ...
            <div class="col-sm-4">
               <img src="<?php echo e(asset('resources/assets/images/add-sample/summer.jpg')); ?>" class="img-responsive" alt="">
            </div>
          </div>  
        </div>
