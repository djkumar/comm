...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">{!! trans('admin.update_product') !!} &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.product_list') }}">{!! trans('admin.products_list') !!}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.add_product') }}">{!! trans('admin.add_new_product') !!}</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" target="_blank" href="{{ route( 'details-page', $product_post_data['post_slug']) }}">{!! trans('admin.view') !!}</a></h3>
