...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.add_new_post_top_title')); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="<?php echo e(route('admin.testimonial_post_list_content')); ?>"><?php echo e(trans('admin.posts_list')); ?></a></h3>
