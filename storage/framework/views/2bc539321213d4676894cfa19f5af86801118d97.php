              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  ...
                  <div class="uploaded-header-slider-images">
                    ...
                    <div class="sample-img" style="display:none;"><img class="upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
                    <div class="uploaded-slider-images" style="display:block;">
                      <?php $__currentLoopData = get_appearance_header_settings_data(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider_img): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <div class="header-slider-image-single-container <?php echo e(substr(basename($slider_img->img_url), 0, -4)); ?>"><img class="img-responsive" src="<?php echo e($slider_img->img_url); ?>"><div data-id="<?php echo e($slider_img->id); ?>" class="remove-frontend-img-link" style="display: none;"></div></div>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </div>
                    <?php else: ?>
                    <div class="sample-img"><img class="upload-icon img-responsive" src="<?php echo e(asset('resources/assets/images/upload.png')); ?>"></div>
